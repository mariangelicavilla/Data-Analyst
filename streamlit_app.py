...
data = pd.read_csv("C:/Users/maria/Documents/Data-Analyst/madrid_data_airbnb_2023.csv")
...
#imprimir los valores unicos de la columna 'minimun_nights
...
nigths_5 = df_selection[df_selection["minimum_nights_group"]=="1 to 5 nights"].value_counts().sum()
nigths_14 = df_selection[df_selection["minimum_nights_group"]=="6 to 14 nights"].value_counts().sum()
nigths_30 = df_selection[df_selection["minimum_nights_group"]=="15 to 30 nights"].value_counts().sum()
nigths_90 = df_selection[df_selection["minimum_nights_group"]=="30 to 90 nights"].value_counts().sum()
nigths_100 = df_selection[df_selection["minimum_nights_group"]=="Over 90 nights"].value_counts().sum()

#placing our metrics within columns in the dashboard
col1,col2,col3,col4,col5,col6=st.columns(6)
col1.metric(label="Total Apartments",value=total_apartments)
col2.metric(label="1 to 5 nights",value=nigths_5)
col3.metric(label="6 to 14 nights",value=nigths_14)
col4.metric(label="15 to 30 nights",value=nigths_30)
col5.metric(label="30 to 90 nights",value=nigths_90)
col6.metric(label="Over 90 nights",value=nigths_100)
